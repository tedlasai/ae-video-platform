...
path = 'D:/PycharmProjects/4d-data-browser/Image_Arrays_exposure_separate/'
algoImages = []
...
path = 'D:/PycharmProjects/4d-data-browser/Image_Arrays_from_dng_separate/'
showImages = []
listdir_ = os.listdir(path)
npy_frames = [path + f for f in listdir_ if f.endswith(('.npy'))]
c = 0
...
filename = 'Scene19_show_dng_imgs'
save_loc_ = path[:-10]
