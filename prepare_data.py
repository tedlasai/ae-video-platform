...
read_path = 'I:\Final\Scene10_WindowDiffuse_OnlyMovingHead'

# read_path = 'J:/Extra/Scene103'

dir_count=0
scene_num='10'
downscale_ratio= 1 #0.12
...
images.sort()
count=0
fn = 'Scene'+scene_num+'_imgs_'+str(downscale_ratio)
with open(fn, mode='wb+') as f:
    for i, image_name in enumerate(images):
        ...
        if i%10:
            batch = np.asarray(list_of_images)
            batch.tofile(f)
            list_of_images = []
...
#np.save(,np.asarray(list_of_images))
